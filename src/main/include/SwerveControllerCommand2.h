...
class SwerveControllerCommand2
 ...
 public:
   ...
   * @param currentState    A function that supplies the current state,
   *                        provided by the drivetrain.
 ...
 private:
  ...
  std::function<wpi::array<frc::SwerveModuleState, NumModules>()> m_currentStates;
